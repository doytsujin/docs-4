...
If you have already [registered a new CockroachCloud account](#reigster-a-new-account) using GitHub, you can log in to CockroachCloud:
...
<section class="filter-content" markdown="1" data-scope="email">
If you have already [registered a new CockroachCloud account](#reigster-a-new-account) using an email address, you can log in to CockroachCloud:
